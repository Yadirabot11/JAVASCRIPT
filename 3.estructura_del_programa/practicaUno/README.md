...
### 3. pedir al usuario una contraseña que debera ser verificada en una condicion simple si es la contraseña correcta.
### 4. pedir al usuario un numero y determina si es un numero primo 
## RECOMENDACION:
